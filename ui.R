...
navbarPage(id = "nav", windowTitle = "FarFish DLMGui",
                  ...
                  tabPanel("Edit data",
                      ...
                      p('Length should be in mm, catch should be in individuals.',
                        'All bins should have a number in, apart from the final column which is the maximum length.',
                        'For the final column all years should be NA.',
                        'All length bins should be the same length.'),
                      hodfr(
                          "cal",
                          fields = list(type = "bins", max = 10),
                          values = list(
                  ...
                  tabPanel("TAC Plot",
                      p(strong("Please Note:"), "Care should be taken in using the outputs of the analysis for management purposes as a solid background and training in stock assessment are required for interpretation"),
